...
Развернуть текущий production-like стек на `Ubuntu 22.04 LTS` с `step-ca` backend, внешним `cert-signer`, `Strapi`, `Postgres`, `Redis` и `nginx` mTLS edge.
...
5. sudo-доступ на Ubuntu 22.04 host
...
### 7. Prepare PKI host layout on Ubuntu
